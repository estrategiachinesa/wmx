...
export default function RegisterPage() {
  ...
  useEffect(() => {
    ...
    if (config && secret) {
      ...
      setSecretValid(false);
       if (!isConfigLoading) { // Prevent redirect while config is still loading
          router.replace('/blocked');
       }
    }
  }, [secret, config, isConfigLoading, router]);
  ...
  if(isSecretValid === false) {
      // router.replace('/blocked') is handled in the useEffect, this prevents flash of content
      return null;
  }
